 ...
 * Workflow Types
 * 
 * Type definitions for Workflow workflow execution.
 * A Workflow is a collection of agents orchestrated to complete a task.
 */
...
export interface WorkflowStep {
    ...
    triggerId?: string;
    /** Coordinator model (from workflow registry) */
...
export interface TriggerDefinition {
    id: string;
    /** Reference to the Workflow workflow via wallet address */
...
// =============================================================================
// Agent & Workflow Card Types (Canonical - matches pinata.ts)
// =============================================================================
...
/**
 * WorkflowCard - Canonical workflow/workflow metadata from IPFS
...
export interface WorkflowCard {
    ...
    /** DNA hash from on-chain */
    dnaHash: string;
    /** Workflow's derived wallet address - SINGLE SOURCE OF TRUTH */
    walletAddress: string;
    /** Timestamp used in wallet derivation */
    walletTimestamp: number;
...
// =============================================================================
// Workflow (On-Chain Workflow NFT)
// =============================================================================

export interface WorkflowMetadata {
    workflowId: number; // On-chain token ID (kept for contract reference)
